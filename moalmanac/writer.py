...
class Actionable:
    sort_columns = [
        Writer.almanac_bin,
        Writer.sensitive_map,
        Writer.resistance_map,
        Writer.prognostic_map,
    ]
    output_columns = [
        Writer.score_bin,
        Writer.sensitive_implication,
        Writer.resistance_implication,
        Writer.prognostic_implication,
        Writer.feature_type,
        Writer.feature,
        Writer.alt_type,
        Writer.alt,
        ...
        Writer.sensitive_therapy,
        Writer.sensitive_therapy_strategy,
        Writer.sensitive_therapy_type,
        Writer.sensitive_oncotree_code,
        Writer.sensitive_description,
        Writer.sensitive_citation,
        Writer.sensitive_url,
        Writer.resistance_bin,
        Writer.resistance_therapy,
        Writer.resistance_therapy_strategy,
        Writer.resistance_therapy_type,
        Writer.resistance_oncotree_code,
        Writer.resistance_description,
        Writer.resistance_citation,
        Writer.resistance_url,
        Writer.prognostic_bin,
        Writer.favorable_prognosis,
        Writer.prognostic_oncotree_code,
        Writer.prognostic_description,
        Writer.prognostic_citation,
        Writer.prognostic_url,
        Writer.number_germline_mutations,
        Writer.validation_coverage,
        Writer.validation_tumor_f,
    ...
    def write(cls, df, patient_id, folder):
        ...
        Writer.log_dataframe(
            label="Clinically relevant observations",
...
class GermlineACMG:
    ...
    def write(cls, df, patient_id, folder):
        ...
        output_name = Writer.create_output_name(folder, patient_id, cls.output_suffix)
        Writer.log_dataframe(
            label="Germline variants in ACMG genes",
            filename=output_name,
            dataframe=output_dataframe,
        )
        Writer.export_dataframe(df=output_dataframe, output_name=output_name)
...
class GermlineCancer:
    sort_columns = [
        Writer.almanac_bin,
        Writer.cancerhotspots_bin,
        Writer.cancerhotspots3D_bin,
        Writer.cgc_bin,
        Writer.gsea_pathways_bin,
        Writer.gsea_cm_bin,
        Writer.cosmic_bin,
        Writer.exac_common,
        Writer.exac_af,
...
class Strategies:
    ...
    def write(cls, df, patient_id, folder):
        output_name = Writer.create_output_name(folder, patient_id, cls.output_suffix)
        Writer.log_dataframe(
            label="Therapeutic strategies that were highlighted",
            filename=output_name,
            dataframe=df,
        )
        Writer.export_dataframe_indexed(
