...
if __name__ == "__main__":
	...
	parser.add_argument('--column_changed', '-c', action="append", help='columns that did change', required=True)
	...
	results = []
	for column in args.column_changed:
		df_difference = merged[~merged[f"{column}_x"].eq(merged[f"{column}_y"])]
		results.append(df_difference)
